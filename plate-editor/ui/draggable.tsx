...
import { STRUCTURAL_TYPES } from "@/plate-editor/plugin/transforms";
import { Button } from "@/plate-editor/ui/button";
import {
    Tooltip,
    TooltipContent,
    TooltipTrigger,
} from "@/plate-editor/ui/tooltip";
    ...
    return (
        <div
            ...
            className={cn(
                ...
                isNodeType([PlaceholderPlugin.key, TablePlugin.key]) &&
                    "pt-3 pb-0",
    ...
    return (
        <Tooltip>
            <TooltipTrigger asChild>
                <div
                    className="flex size-full items-center justify-center hover:cursor-pointer"
                    onClick={() => {
                        editor
