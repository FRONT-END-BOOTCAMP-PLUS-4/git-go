...
export default function SettingsPanel() {
    ...
    return (
        <div className="border-border-primary1 m-4 rounded-lg border-1 bg-white">
            ...
            <div className="p-6">
                ...
                <div className="border-border-primary1 border-b-1 pb-4">
                    <p className="mb-3 text-[16px] font-normal">테마 설정</p>
                ...
                {/* 계정 관리 */}
                <div className="py-4">
                    <p className="mb-2 text-[16px] font-normal">계정 관리</p>
