...
export default function Button({
    ...
    return (
        <button
            ...
            onClick={onClick}
            disabled={isDisabled}
            className={`shadow-border-primary1 flex items-center gap-x-2 rounded-md px-3 py-2.5 text-xs font-semibold whitespace-nowrap shadow-xs transition-colors active:scale-[0.97] ${styleClass} ${sizeClass}`}
        >
